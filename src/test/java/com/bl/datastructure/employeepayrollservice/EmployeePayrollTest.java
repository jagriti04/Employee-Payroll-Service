...
public class EmployeePayrollTest {
	...
	public void givenThreeEmpData_whenWrittenToFile_shouldMatchEmpEntriesCount() {
		EmployeePayrollData[] empsArray = { new EmployeePayrollData(1, "Jeff Bezos", 1020.0),
				new EmployeePayrollData(2, "Bill Bezos", 2020.0), new EmployeePayrollData(3, "Mark Bezos", 3020.0) };
